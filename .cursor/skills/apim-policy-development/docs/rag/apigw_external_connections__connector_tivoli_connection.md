...
source: https://docs.axway.com/bundle/axway-open-docs/page/docs/apim_policydev/apigw_external_connections/connector_tivoli_connection/index.html
scrapedAt: 2026-08-21T20:46:02.602Z
---
...
Before you can configure the Tivoli Authorization filter, you must configure API Gateway for integration with TAM. For more details, see the API Gateway Authentication and Authorization Integration Guide.

 ...
 * @internal
 */
function transformOAuthCredential(cred) {
    return {
 ...
 * @internal
 */
function transformPermission(perm) {
    return {
 ...
 */
export async function getApplication(api, id) {
    try {
 ...
 */
export async function getApiKeysForApplication(api, id) {
    try {
 ...
 */
export async function createApiKey(api, appId, enabled = true, secret) {
    try {
 ...
 */
export async function getOAuthCredentialsForApplication(api, id) {
    try {
 ...
 */
export async function createOAuthCredential(api, appId, redirectURIs, cert) {
    try {
 ...
 */
export async function getPermissionsForApplication(api, id) {
    try {

 ...
 */
export async function getOrganization(api, id) {
    try {
 ...
 */
export async function createOrganization(api, name, description, email, phone, enabled = true) {
    try {
 ...
 */
export async function updateOrganization(api, id, name, description, email, phone, enabled) {
    try {
 ...
 */
export async function deleteOrganization(api, id) {
    try {

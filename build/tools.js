...
const tool51 = {
    ...
    parameters: z.object({
        ...
        regenerateXml: z
            .boolean()
            .optional()
            .describe("Tier 1: regenerate XML before validate via yaml-frag-to-xml (writes files; needs resolved gatewayHome)"),
    }).shape,
};
const tool52 = {

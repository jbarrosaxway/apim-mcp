 ...
 * @internal
 */
function transformApiAccess(access: any) {
  return {
 ...
 */
export async function listApiAccess(api: AxwayApi, applicationId: string) {
  try {
 ...
 */
export async function grantApiAccess(api: AxwayApi, applicationId: string, apiId: string) {
  try {
 ...
 */
export async function revokeApiAccess(api: AxwayApi, applicationId: string, apiId: string) {
  try {

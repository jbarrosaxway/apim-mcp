...
4. Autor YAML/XML fragment; validar com \`axway_apim_fragment_validate\` (Tier 0 offline; Tier 1 com mapeamento gatewayHome); XML via \`axway_apim_fragment_yaml_to_xml\` (Tier 1); sync ps-project com \`axway_apim_fragment_sync_ps_project\` (Tier 0); \`axway_apim_fragment_gateway_resolve\` para verificar mapeamento; importar no Policy Studio
...
export function loadGatewayCodeAnalysisPlaybook(): string {
...
export function listPolicyDevDocSlugs(): string[] {
...
export function loadPolicyDevDoc(slug: string): string | null {

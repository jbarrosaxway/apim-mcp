...
const tool51 = {
  ...
  parameters: z.object({
    fragmentPath: z
      ...
      .optional()
      .describe(
        "Package root relative to repo or absolute (e.g. policies/example-policy-package)"
      ),
...
const tool52 = {
  ...
  parameters: z.object({
    ...
    xmlOutputPath: z
      ...
      .optional()
      .describe(
        "Output XML path; default fragment-xml/example-policy-package-fragment.xml under package"
      ),
    gatewayHome: z
      .string()
      .optional()

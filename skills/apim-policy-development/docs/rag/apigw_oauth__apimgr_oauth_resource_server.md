...
source: https://docs.axway.com/bundle/axway-open-docs/page/docs/apim_policydev/apigw_oauth/apimgr_oauth_resource_server/index.html
scrapedAt: 2026-08-21T20:46:38.702Z
---
...
For more information on virtualizing APIs in API Manager and protecting those APIs with OAuth, see Virtualize REST APIs in API Manager.
...
OAuth authorizations are stored in the Authorizations table in the OAuth KPS collection. This is a hidden KPS collection that is not visible in Policy Studio by default. For more information on viewing hidden KPS collections in Policy Studio, see the API Gateway Key Property Store User Guide.
...
- API Manager – See View and revoke OAuth authorizations in API Manager.

- API Manager REST API – For more information, see the Product APIs page on the Axway Documentation portal.

- kpsadmin tool – For more information, see the API Gateway Key Property Store User Guide.
...
You can also add OAuth scopes at the client application level if you have enabled global scopes as described in Enable global scopes in API Manager.
...
For more information on registering and managing client applications in API Manager, see Manage client applications in API Manager.

##### On this page

- Protect APIs with OAuth

- Scopes in API Manager Enable global scopes in API Manager

- Authorization management in API Manager View and revoke OAuth authorizations in API Manager

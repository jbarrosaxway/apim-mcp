...
source: https://docs.axway.com/bundle/axway-open-docs/page/docs/apim_policydev/apigw_poldev/gs_concepts/index.html
scrapedAt: 2026-08-21T20:44:07.342Z
---
...
For details, see Install API Gateway.
...
Selectors are powerful a feature when extending the API Gateway to integrate with other systems. For more details on selectors, see Select configuration values at runtime.
...
For more information on importing and creating certificates and keys, see Manage certificates and keys.
...
Manage API Gateway users contains more details on how to create users, user groups, and attributes.

...
source: https://docs.axway.com/bundle/axway-open-docs/page/docs/apim_policydev/apigw_polref/routing_getstarted/index.html
scrapedAt: 2026-08-21T20:47:10.412Z
---
...
There are differences between how the filters are configured to route on through a proxy and the scenario described in Use case 4: Endpoint with service virtualization where no proxy is involved:
...
- Use cases Use case 1: Proxy without service virtualization Use case 2: Proxy with service virtualization Use case 3: Endpoint without service virtualization Use case 4: Endpoint with service virtualization Use case 5: Simple redirect Use case 6: Routing on to an HTTP proxy

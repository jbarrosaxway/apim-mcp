...
source: https://docs.axway.com/bundle/axway-open-docs/page/docs/apim_policydev/apigw_oauth/oauth_message_attributes/index.html
scrapedAt: 2026-08-21T20:46:49.664Z
---
...
- OAuth 2.0 server message attributes accesstoken methods accesstoken.authn methods authzcode methods oauth.client.details methods Example of querying a message attribute OAuth scope attributes OAuth SAML bearer attributes

- OAuth 2.0 client message attributes oauth.client.accesstoken methods oauth.client.application methods

...
source: https://docs.axway.com/bundle/axway-open-docs/page/docs/apim_policydev/apigw_polref/conversion_additional/index.html
scrapedAt: 2026-08-21T20:47:36.999Z
---
...
- Add XML node filter Where to insert new nodes Node source New node details Attribute node details Add XML node examples Replace an attribute value Add an attribute Add an element Replace an element

- Remove XML node filter Remove XML node filter exceptions
...
- Load file contents filter Input settings Processing settings On completion settings

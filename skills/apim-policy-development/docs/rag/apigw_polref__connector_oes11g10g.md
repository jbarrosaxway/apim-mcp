...
source: https://docs.axway.com/bundle/axway-open-docs/page/docs/apim_policydev/apigw_polref/connector_oes11g10g/index.html
scrapedAt: 2026-08-21T20:48:20.595Z
---
...
Resource Naming Authority: Enter apigatewayResource to match the Naming Authority Definition loaded in the OES 10g settings. For more details, see Oracle Security Service Module settings (10g).
...
- Oracle Entitlements Server 10g authorization filter Settings Application Context

- Get roles from Oracle Entitlements Server 10g filter Get roles settings Get roles application context

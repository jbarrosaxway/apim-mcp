...
Languages: [English](../en/axway-mcp-audit-1.0.17.md) | [Português (Brasil)](axway-mcp-audit-1.0.17.md)
...
Meta GA-ready (≥70, 0 Critical, ≤3 High) **cumprida** para tudo exceto o finding conhecido de produto.
